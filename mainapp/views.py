...
def farmers(request):
	...
	return render(request,"farmers.html",{'farmers':farmers,'total_size':size})
...
def single_stock(request,id):
	...
	return render(request,"single-stock.html",{'stock':stock})
...
def stock_action(request,action):
	...
	return render(request,"stock-action.html",{'product_details':data,'action':action,'quantity':quantity})
...
def pest(request):
	...
	return render(request,"pests.html",{'pests':pests})
...
def single_pest(request,id):
	...
	return render(request,"single-pest.html",{'pest':pest,'images':images})
...
def sales(request):
	...
	return render(request,"sales.html",{'sales':sales,'total_price':total_price})
...
def single_sale(request,id):
	...
	return render(request,"single-sale.html",{'sale':sale})
...
def supplies(request):
	...
	return render(request,"supplies.html",{'supplies':supplies,'total_value':total_value,'total_weight':total_weight})
...
def single_supply(request,id):
	...
	return render(request,"single-supply.html",{'supply':supply})
...
def transformed_products(request):
	...
	return render(request,"transformed_products.html",{'products':products,'total_weight':total_weight})
